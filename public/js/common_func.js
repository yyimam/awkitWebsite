(function ($) {
	...
	// Menu
	$('a.menuCloser').on("click", function () {
...
// $(".checkebox_class").ready(function (){
//     $(".checkebox_class:input:checkbox").each(function (index){
//         this.checked = (".checkebox_class:input:checkbox" < max_limit);
//     }).change(function (){
//         if ($(".checkebox_class:input:checkbox:checked").length > max_limit){
//             this.checked = false;
//         }
//     });
// });
...
// var limit = 2;
// $('input.checkebox_class').on('change', function() {
